namespace DrawXXL
{
    ...
    public class BezierSplineDrawerInspector : VisualizerParentInspector
    {
        ...
        {
            Start_handlesChangeCheck();
            var fmh_1183_188_638564069235322410 = Quaternion.identity; Vector3 posOfSphereHandle_afterDrag_shifedInsideCamPlane_inUnitsOfGlobalSpace = Handles.FreeMoveHandle(controlID_ofHandle, concernedHelperPoint.GetPos_inUnitsOfGlobalSpace(), handleSize, Vector3.one, Handles.SphereHandleCap);
            bool hasChanged = End_handlesChangeCheck("Position of Bezier Point", i, true);
